...
class Command(BaseCommand):
    ...
    def seed_hp(self):
        """Seed HP/HPE servers, workstations, and laptops."""
        vendor, created = Vendor.objects.get_or_create(
            name='Hewlett Packard Enterprise',
            defaults={
                'slug': slugify('Hewlett Packard Enterprise'),
                'website': 'https://www.hpe.com',
                'support_url': 'https://support.hpe.com',
                'support_phone': '1-800-633-3600',
                'description': 'Enterprise servers, storage, and networking solutions',
                'is_active': True,
            }
        )
        ...
        equipment = [
            # HPE ProLiant Servers
            {
                ...
                'model_number': 'DL380-G11',
                'equipment_type': 'server',
                'is_rackmount': True,
                'rack_units': 2,
                'specifications': {
                    'processor': 'Dual Intel Xeon Scalable 4th Gen or AMD EPYC',
                    'memory': 'Up to 8TB DDR5',
                    'storage': 'Up to 30 SFF drives',
                    'power': '800W-2000W redundant PSU',
                    'network': '4x 1GbE ports'
                },
                'description': '2U rack server for virtualization and cloud'
            },
            {
                ...
                'description': '2U rack server for demanding workloads'
            },
            {
                'model_name': 'ProLiant DL380 Gen9',
                'model_number': 'DL380-G9',
                'equipment_type': 'server',
                'is_rackmount': True,
                'rack_units': 2,
                'specifications': {
            ...
            },
            {
                ...
                'description': '1U rack server for scale-out deployments'
            },
            {
                'model_name': 'ProLiant DL360 Gen9',
                'model_number': 'DL360-G9',
                'equipment_type': 'server',
                'is_rackmount': True,
                'rack_units': 1,
                'specifications': {
            ...
            },
            {
                ...
                'model_number': 'DL325-G11',
                'equipment_type': 'server',
                'is_rackmount': True,
                'rack_units': 1,
                'specifications': {
                    'processor': 'Single AMD EPYC 4th Gen',
                    'memory': 'Up to 2TB DDR5',
                    'storage': 'Up to 10 SFF drives',
                    'power': '500W-800W PSU'
                },
                'description': '1U AMD-based rack server'
            },
            {
                'model_name': 'ProLiant DL345 Gen11',
                'model_number': 'DL345-G11',
                'equipment_type': 'server',
                'is_rackmount': True,
                'rack_units': 1,
                'specifications': {
            ...
            },
            {
                ...
                'description': '2U AMD dual-socket server'
            },
            {
                'model_name': 'ProLiant ML350 Gen11',
                'model_number': 'ML350-G11',
                'equipment_type': 'server',
                'is_rackmount': False,
                'specifications': {
                    'processor': 'Dual Intel Xeon Scalable',
                    'memory': 'Up to 4TB DDR5',
                    'storage': 'Up to 16 LFF drives',
                    'power': '800W-1600W redundant PSU',
                    'form_factor': 'Tower'
                },
            ...
            },
            {
                ...
                'model_number': 'ML110-G10',
                'equipment_type': 'server',
                'is_rackmount': False,
                'specifications': {
                    'processor': 'Single Intel Xeon E-2300',
                    'memory': 'Up to 128GB DDR4',
                    'storage': 'Up to 8 LFF drives',
                    'power': '550W PSU',
                    'form_factor': 'Tower'
                },
            ...
            # HP EliteDesk Desktops
            {
                ...
                'description': 'Premium business desktop'
            },
            {
                'model_name': 'EliteDesk 800 G8',
                'model_number': '800-G8',
                'equipment_type': 'workstation',
                'is_rackmount': False,
                'specifications': {
            ...
            },
            {
                ...
                'description': 'Essential business desktop'
            },
            ...
            },
            {
                ...
                'description': 'Affordable 15" business laptop'
            },
            {
            ...
            },
            {
                ...
                'is_rackmount': False,
                'specifications': {
                    'processor': 'Intel Core i9 13th Gen or Xeon',
                    'memory': 'Up to 128GB DDR5',
                    'storage': 'M.2 NVMe SSD up to 8TB',
                    'display': '15.6" or 17.3" UHD',
                    'graphics': 'NVIDIA RTX A series',
                    'weight': '5.5 lbs'
                },
                'description': 'Extreme performance mobile workstation'
            },
        ]
        ...
        for eq_data in equipment:
            eq, created = EquipmentModel.objects.get_or_create(
                ...
                defaults={
                    **eq_data,
                    'slug': slugify(f"hpe-{eq_data['model_name']}")
                }
            )
            if created:
